...
Original fork (see commits) used AFLW dataset for training and  FDDB dataset for testing

This fork uses HollywoodHeads dataset for training (and COCOdb non-persons for negatives)
